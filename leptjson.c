    ...
    switch (lhs->type) {
        ...
        case LEPT_OBJECT:
            ...
            for (i = 0; i < lhs->u.o.size; i++){
                size_t index;
                if ((index = lept_find_object_index(rhs, lhs->u.o.m[i].k, lhs->u.o.m[i].klen)) == LEPT_KEY_NOT_EXIST || !lept_is_equal(&lhs->u.o.m[i].v, &rhs->u.o.m[index].v))
                    return 0;
            }
            //
            return 1;
...
lept_value* lept_insert_array_element(lept_value* v, size_t index) {
    ...
    if (v->u.a.size == v->u.a.capacity)
        lept_reserve_array(v, v->u.a.capacity == 0 ? 1 : v->u.a.capacity * 2);
    memmove(&v->u.a.e[index+1], &v->u.a.e[index], sizeof(lept_value)*(v->u.a.size-index));
...
void lept_erase_array_element(lept_value* v, size_t index, size_t count) {
    ...
    memmove(&v->u.a.e[index], &v->u.a.e[index+count], sizeof(lept_value)*(v->u.a.size-(index+count)));
    v->u.a.size -= count;
}
